...
export default function HomePage() {
  return (
    <div className="p-5 pt-24 flex flex-col flex-wrap justify-center align-middle gap-5 font-LYLAS">
      ...
      <Image src="/img/hamburgerMain.jpg" alt="Hamburger Icon" width={500} height={500} priority={true} style={{ maskImage: 'linear-gradient(black 40%, transparent)',width: "500px",height: "auto"}} />
